...
refine
 (fix exl (i:inst) (h:forLoops i) {struct h} :
    ...
    fun s =>
      ...
      | is_Skip heq => exec_skip i s heq
      | is_assign v e heq => exec_assign i s v e heq
      | is_seq i1 i2 heq => exec_sequence i s i1 i2 heq _ _
      | is_while b i' heq => exec_forLoop i i' b s heq _ _
      end).
